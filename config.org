...
#+CATEGORY: CONFIG
Time-stamp: <2020-04-11 10:15:10 alisterpillow>
...
(setq doom-theme 'doom-opera) ;; This has a better separation between inactive and active buffers.
...
#+RESULTS:
| paredit-mode |
** TODO Fixes for company-mode in CIDER
