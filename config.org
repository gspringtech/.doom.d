...
#+CATEGORY: CONFIG
Time-stamp: <2026-04-13 12:08:36 alisterpillow>
...
#+BEGIN_SRC emacs-lisp
(after! org
    (set-face-attribute 'org-document-title nil :height 1.5 :background 'unspecified :weight 'light)
    (set-face-attribute 'org-level-1 nil :height 1.4 :background 'unspecified :weight 'light)
    (set-face-attribute 'org-level-2 nil :height 1.3 :background 'unspecified :weight 'light)
    (set-face-attribute 'org-level-3 nil :height 1.2 :background 'unspecified :weight 'normal)
    (set-face-attribute 'org-level-4 nil :height 1.0 :background 'unspecified :weight 'semi-bold)
    (set-face-attribute 'org-link nil    :height 1.0 :background 'unspecified :weight 'normal)
    )
...
*** Fix for gpg 2.4 hanging - downgrade to 2.2 (EPA)
#+begin_src emacs-lisp :tangle no
